    ...
    <div id="downbar">
        <div id="barra-completa">
            <div id="fichas" class="barra">
                <img src="../assets/img/2d-blue.PNG" alt="ficha azul" class="ficha">
                <img src="../assets/img/2d-yellow.PNG" alt="ficha amarilla" class="ficha">
                <img src="../assets/img/2d-pink.PNG" alt="ficha rosa" class="ficha">
                <img src="../assets/img/2d-green.PNG" alt="ficha verde" class="ficha">
                <img src="../assets/img/2d-orange.PNG" alt="ficha naranja" class="ficha">
                <img src="../assets/img/2d-red.PNG" alt="ficha roja" class="ficha">
            </div>
